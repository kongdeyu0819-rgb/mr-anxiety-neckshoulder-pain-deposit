...
- ✅ 稿件 Declarations 已回填 GitHub 仓库 URL + Zenodo DOI
- ✅ **Zenodo DOI 已获取**：版本 DOI 10.5281/zenodo.22764939（v1.0.1）；概念 DOI 10.5281/zenodo.22764938
  - 存档记录：https://zenodo.org/records/22764939 （含自动归档的仓库 zip 78 KB）
  - 排障记录：首次 Release 早于开关打开 → webhook 未触发；重建 Release 后事件被接受但记录未生成；最终以 v1.0.1 新 Release 成功入库
